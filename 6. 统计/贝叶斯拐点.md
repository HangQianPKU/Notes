...
$$
\begin{aligned}
\underbrace{\mathbb{P}(\theta | Y)}_{\text{后验概率(在获得了模型的样本后，对参数的新认识)}} = \underbrace{\mathbb{P}(\theta)}_{\text{先验概率——对模型参数的先验认识}} · \underbrace{\mathbb{}}
\end{aligned}
$$
...
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1NjI2MDg3NiwxNDY2NTk5MTk2LC0xMz
I5MjExOTc0LDEyOTg1MzIyNDYsLTYxNDUxNTkwNSwtMjEwNzE3
ODY4MiwxNzUxNTIwNjgsLTg0MjU0NTQ3MywtMTU0MjQxODMxMl
19
-->