...
$X=\sum_{n=1}^N Y_n$: **某段时间内**产生并保留下来的锆石个数（单位：个数）

$p$: 与$\frac{\text{collision}}{\text{subduction}}$正相关的量，该值越大，表明某一时间段内全球构造环境的col


<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc5ODg0NzksMTc5NzgwODg1NiwtMTk4ND
g0MTA4NSwxNDY2NTk5MTk2LC0xMzI5MjExOTc0LDEyOTg1MzIy
NDYsLTYxNDUxNTkwNSwtMjEwNzE3ODY4MiwxNzUxNTIwNjgsLT
g0MjU0NTQ3MywtMTU0MjQxODMxMl19
-->