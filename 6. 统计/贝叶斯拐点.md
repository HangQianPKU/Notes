...
$p$: 与$\frac{\text{collision}}{\text{subduction}}$正相关的量，该值越大，表明某一时间段内全球**正在发生火山事件的构造环境**中collision占比多，subduction占比少


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NzY2MzIxNSwxNzk3ODA4ODU2LC0xOT
