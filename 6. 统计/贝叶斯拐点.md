...
$p$: 与$\frac{\text{subduction}}{\text{collision}}$正相关的量，该值越大，表明某一时间段内全球**正在发生火山事件的构造环境**中subduction占比多，collision占比少, pre


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwNjIxODEyNCwxNzk3ODA4ODU2LC0xOT
